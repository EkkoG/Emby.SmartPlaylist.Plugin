    ...
    public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages, IHasThumbImage
    {
        ...
        public IEnumerable<PluginPageInfo> GetPages()
        {
            return new[]
            {
                new PluginPageInfo
                {
                    Name = "smartplaylist.2.5.1.4860.html",
                    EmbeddedResourcePath = GetType().Namespace + ".Configuration.smartplaylist.2.5.1.4860.html",
                ...
                new PluginPageInfo
                {
                    Name = "smartplaylist.2.5.1.4860.js",
                    EmbeddedResourcePath = GetType().Namespace + ".Configuration.smartplaylist.2.5.1.4860.js"
                }
            };
        }
